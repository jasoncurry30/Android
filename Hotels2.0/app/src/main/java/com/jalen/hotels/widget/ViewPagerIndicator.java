...
public class ViewPagerIndicator extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int offset = (int) ((mNum) * (mRadius + mDistance)) / 2;
        canvas.translate(width - offset, height / 2);
        //初始化画笔
        initPaint();
        //距离
    ...
    private void setStyleable(Context context, AttributeSet attrs) {
        ...
        mSelected_color = array.getColor(R.styleable.ViewPagerIndicator_selected_color, 0x80FFFFFF);
        mDefault_color = array.getColor(R.styleable.ViewPagerIndicator_default_color, 0x80FFFFFF);
